...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.login-btn').click(function () {
                ...
                $(this).find('.btn-text').text('Logging in...');
    ...
    <style type="text/css">
        ...
        * {
        ...
        /* Company and Division dropdowns */
        .form-select {
            width: 100%;
            padding: 16px 16px 16px 48px;
            border: 2px solid var(--border-color);
                    ...
                    <LayoutTemplate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="UserName" runat="server" CssClass="form-input" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="Password" runat="server" TextMode="Password" 
                                            CssClass="form-input" placeholder="Enter your password"></asp:TextBox>
                            </div>
                        ...
                        <asp:Button ID="LoginButton" runat="server" CommandName="Login" 
                                   CssClass="login-btn" ValidationGroup="Login1">
                        ...
                        <!-- Signup Button -->
                        <a href="#" class="signup-btn">Signup Now</a>
                    </LayoutTemplate>
                </asp:Login>
            </div>
